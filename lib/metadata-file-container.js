		...
		if (parsed) {
			...
			if (self.getMetadataType().childXmlNames) {
				...
				if (selfContents !== otherContents) {
					other.contents = Buffer.from(otherContents);
...
MetadataFileContainer.prototype.contentsWithoutChilds = function() {
