...
var Config = module.exports = function(opts) {
	...
	if (config === undefined) {
		...
		config.nonEditableManagedMetadataTypes = ['ApexClass', 'SharingReason', 'ApexTrigger', 'CompactLayout', 'CustomLabel', 'CustomPermission', /* CustomSetting */ 'FlexiPage', 'HomePageComponent', 'AuraDefinitionBundle', 'PermissionSet', 'PlatformCachePartition', 'StaticResource', 'Translation', 'ApexComponent', 'ApexPage'];
