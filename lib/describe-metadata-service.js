...
var customObjectRequiredFields = ['label', 'pluralLabel', 'nameField', 'deploymentStatus', 'sharingModel', 'fullName'];
...
var DescribeMetadataService = module.exports = function(describeMetadataResult) {
	...
	self.customObjectRequiredFields = customObjectRequiredFields;
	self.metadataObjectsExtended = self.metadataObjectsExtended.concat(additionalMetadataTypes);
};

DescribeMetadataService.prototype.getCustomObjectRequiredFields = function() {
	var self = this;
	return self.customObjectRequiredFields;
};
