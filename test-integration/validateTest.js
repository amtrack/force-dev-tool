...
describe('force-dev-tool validateTest', function() {
	...
	it('should simulate deploying an apex class with a failing test class', function() {
		this.timeout(1000 * 60 * 10);
		this.slow(1000 * 60 * 5);
		var validateTestCmd = child.spawnSync("node", [fdt, 'validateTest', '-d', path.resolve(__dirname, '..', 'test', 'data', 'unpackaged', 'apex-failing')]);
